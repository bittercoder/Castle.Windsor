...
namespace Castle.MicroKernel.ComponentActivator
{
	...
	public interface IDependencyAwareActivator
	{
		...
		/// <summary>
        /// Should return <c>true</c> if the activated instances of the <see paramref="component"/> are managed externally to the container. That means container will not try to track the objects in <see cref="IReleasePolicy"/>.
		/// </summary>
		/// <param name="component"></param>
		/// <returns></returns>
